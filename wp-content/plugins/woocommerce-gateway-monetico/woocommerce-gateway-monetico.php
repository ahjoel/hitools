 ...
 * @category    Plugin
 * @copyright   Copyright (c) 2000-2019, Nicolas Maillard ABSOLUTE Web
...
function init_gateway_monetico() {
	...
	if(!defined("PASSERELLE_MONETICO_VERSION")) define("PASSERELLE_MONETICO_VERSION", "2.0.1");
	...
	<input type="radio" name="mode" id="fifory" value="fifory"><label for="fifory">Fivory</label>';*/
		...
		public function generate_monetico_form( $order_id ) {
			...
			$rawContexteCommand = "{
			 ...
			 \"addressLine2\":\"".$facturation_adresse_2."\",
			 \"city\":\"".$facturation_ville."\",
			 \"postalCode\":\"".$facturation_cp."\",
			 \"country\":\"".$facturation_pays."\"
			 }";
			if(!empty(trim($expedition_adresse_1.$expedition_ville.$expedition_cp.$expedition_pays))):
				$rawContexteCommand .= ",
				 \"shipping\":{
				 \"firstName\":\"".$expedition_prenom."\",
				 \"lastName\":\"".$expedition_nom."\",
				 \"addressLine1\":\"".$expedition_adresse_1."\",
				 \"addressLine2\":\"".$expedition_adresse_2."\",
				 \"city\":\"".$expedition_ville."\",
